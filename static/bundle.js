...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err);}_next(undefined);});};}\nvar commentForm = document.getElementById(\"jsCommentForm\");\nvar commentsList = document.getElementById(\"jsCommentsList\");\nvar commentsNumber = document.getElementById(\"jsCommentsNumber\");\nvar deleteCommentForms = document.getElementsByClassName(\"jsDeleteComment\");\n\nfunction getVideoId() {\n  return window.location.href.split(\"videos\")[1];\n}\n\nfunction incrementCommentsCount() {\n  commentsNumber.innerHTML = parseInt(commentsNumber.innerHTML) + 1;\n}\n\nfunction decrementCommentsCount() {\n  commentsNumber.innerHTML = parseInt(commentsNumber.innerHTML) - 1;\n}\n\nfunction addComment(comment) {\n  var list = document.createElement(\"li\");\n  var span = document.createElement(\"span\");\n  span.innerHTML = comment;\n  list.appendChild(span);\n  commentsList.appendChild(list);\n  incrementCommentsCount;\n}function\n\nhandleAddSubmit(_x) {return _handleAddSubmit.apply(this, arguments);}function _handleAddSubmit() {_handleAddSubmit = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {var commentInput, comment, videoId, response;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:\n            event.preventDefault();\n            commentInput = commentForm.querySelector(\"input\");\n            comment = commentInput.value;\n            commentInput.value = \"\";\n\n            videoId = getVideoId();_context.next = 7;return (\n              axios__WEBPACK_IMPORTED_MODULE_0___default()({\n                url: \"/api\".concat(videoId, \"/comment\"),\n                method: \"POST\",\n                data: { comment: comment } }));case 7:response = _context.sent;\n\n\n            if (response.status === 200) {\n              addComment(comment);\n            }case 9:case \"end\":return _context.stop();}}}, _callee);}));return _handleAddSubmit.apply(this, arguments);}\n\n\nfunction initAddComment() {\n  commentForm.addEventListener(\"submit\", handleAddSubmit);\n}function\n\nsendDeleteComment(_x2) {return _sendDeleteComment.apply(this, arguments);}function _sendDeleteComment() {_sendDeleteComment = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(event) {var videoId, comment, response;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:\n            videoId = getVideoId();\n            comment = event.target.closest(\"li\").childNodes[0].innerHTML;\n            console.log(comment);_context2.next = 5;return (\n              axios__WEBPACK_IMPORTED_MODULE_0___default()({\n                url: \"/api\".concat(videoId, \"/delete-comment\"),\n                method: \"POST\",\n                data: { comment: comment } }));case 5:response = _context2.sent;\n\n\n            if (response.status === 200) {\n              deleteComment(event.target);\n            }case 7:case \"end\":return _context2.stop();}}}, _callee2);}));return _sendDeleteComment.apply(this, arguments);}\n\n\nfunction deleteComment(deleteInput) {\n  var enclosingUl = deleteInput.closest(\"ul\");\n  enclosingUl.removeChild(deleteInput.closest(\"li\"));\n  decrementCommentsCount();\n}\n\nfunction handleDeleteSubmit(event) {\n  event.preventDefault();\n  sendDeleteComment(event);\n}\n\nfunction initDeleteComment() {\n  Array.from(deleteCommentForms).forEach(function (form) {\n    form.addEventListener(\"click\", handleDeleteSubmit);\n  });\n}\n\nif (commentForm) {\n  initAddComment();\n}\n\nif (deleteCommentForms) {\n  initDeleteComment();\n}\n\n//# sourceURL=webpack:///./assets/js/addComment.js?");
...
eval("function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err);}_next(undefined);});};}var videoContainer = document.getElementById(\"jsRecordContainer\");\nvar recordButton = document.getElementById(\"jsRecordButton\");\nvar videoPreview = document.getElementById(\"jsVideoPreview\");\nvar videoRecorder = null;\nvar stream = null;\n\nfunction stopRecording() {\n  videoRecorder.stop();\n  stream.getVideoTracks()[0].stop();\n  recordButton.removeEventListener(\"click\", stopRecording);\n  recordButton.addEventListener(\"click\", getMedia);\n  recordButton.innerHTML = \"Start Recording\";\n}\n\nfunction handleData(event) {\n  console.log(event);\n  var videoFile = event.data;\n  var anchor = document.createElement(\"a\");\n  anchor.href = URL.createObjectURL(videoFile);\n  anchor.download = \"recorded.mp4\";\n  document.body.appendChild(anchor);\n  anchor.click();\n}\n\nfunction startRecording() {\n  if (videoRecorder === null) {\n    videoRecorder = new MediaRecorder(stream);\n  }\n  videoRecorder.start();\n  videoRecorder.addEventListener(\"dataavailable\", handleData);\n  recordButton.addEventListener(\"click\", stopRecording);\n  recordButton.removeEventListener(\"click\", startRecording);\n  recordButton.innerHTML = \"Stop Recording\";\n}function\n\ngetMedia() {return _getMedia.apply(this, arguments);}function _getMedia() {_getMedia = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.prev = 0;_context.next = 3;return (\n\n              navigator.mediaDevices.getUserMedia({\n                audio: true,\n                video: true }));case 3:stream = _context.sent;\n\n            videoPreview.srcObject = stream;\n            videoPreview.muted = true;\n            videoPreview.play();\n\n            startRecording();_context.next = 14;break;case 10:_context.prev = 10;_context.t0 = _context[\"catch\"](0);\n\n            console.log(_context.t0);\n            recordButton.innerHTML = \"Cannot Record.\";case 14:_context.prev = 14;\n\n            recordButton.removeEventListener(\"click\", getMedia);return _context.finish(14);case 17:case \"end\":return _context.stop();}}}, _callee, null, [[0, 10, 14, 17]]);}));return _getMedia.apply(this, arguments);}\n\n\n\nfunction init() {\n  recordButton.addEventListener(\"click\", getMedia);\n}\n\nif (videoContainer) {\n  init();\n}\n\n//# sourceURL=webpack:///./assets/js/videoRecording.js?");
...
eval("__webpack_require__(/*! @babel/polyfill */\"./node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! C:\\Dev\\WeTube\\assets\\js\\main.js */\"./assets/js/main.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./assets/js/main.js?");
